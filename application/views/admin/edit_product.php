                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="form-group">
                                                     ...
                                                     <div class="form-group">
                                                        ...
                                                        <input type="number" class="form-control" name="price_old" id="price_old" placeholder="Nhập giá" value="<?php echo $product['price_old'] ?>">
                                                    </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group t-form-group">
                                                        ...
                                                        <textarea class="form-control" name="parameter"  id="parameter" placeholder="Nhập thông số sản phẩm" rows="5" cols="25"><?php echo $product['parameter'] ?></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group t-form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="thuong_hieu" id="thuong_hieu" placeholder="Nhập thưing hiệu" value="<?php echo $product['thuong_hieu'] ?>">
                                                    </div>
                                                    <div class="form-group t-form-group">
