        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-body">
                    <form class="form" id="add_edit_style">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="">Tên kiểu dáng <span>*</span></label>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="status" id="status" class="form-control">
                                       <option value="1"  <? if ($type == "edit") {if($style['status'] == '1' ) echo "selected";}?>>Bật</option>
                                        <option value="0"  <? if ($type == "edit") {if($style['status'] == '0' ) echo "selected";}?>>Tắt</option>
                                    </select>
                                </div>
                            </div>
                        </div>
